...
public class MediaPlayer implements Runnable
{
	...
	public void playSound() throws FileNotFoundException, UnsupportedAudioFileException, IOException, LineUnavailableException
	{
				...
				// filename.toLowerCase().endsWith(".ogg"))
		{
			...
			final AudioInputStream in = AudioSystem.getAudioInputStream(new File(filename));

			final AudioFormat baseFormat = in.getFormat();
			audioFormat = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, baseFormat.getSampleRate(), 16, baseFormat.getChannels(),
